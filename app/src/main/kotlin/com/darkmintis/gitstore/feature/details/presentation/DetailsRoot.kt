...
import com.darkmintis.gitstore.feature.details.presentation.components.states.ErrorState
import com.darkmintis.gitstore.feature.details.presentation.utils.LocalTopbarLiquidState
import com.darkmintis.gitstore.feature.details.presentation.utils.isLiquidTopbarEnabled
        ...
        onAction = { action ->
            when (action) {
                ...
                is DetailsAction.OnMessage -> {
                    coroutineScope.launch {
                        snackbarHostState.showSnackbar(context.getString(action.messageText))
                    }
                }
